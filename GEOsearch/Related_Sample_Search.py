        ...
        for value in values:
            if key in first_samples:
                writer.writerow([key, first_samples[key].features, first_samples[key].series,
                                 value, second_samples[value].features, second_samples[value].series])
            else:
                writer.writerow([key, second_samples[key].features, second_samples[key].series,
                                 value, first_samples[value].features, first_samples[value].series])
    output.close()
    return pairs
...
if __name__ == "__main__":
    Related_Sample_Search("H3K4me3_vs_H3K27me1", ["h3k4me3", "k4me3", "k4m3", "h3k4m3"],[],
                          ...
                          first_geo=True, first_geofile="uniqueGSM_GEOsearch.txt",
                          second_geo=True, second_geofile="unique_H3K27me3.txt")
